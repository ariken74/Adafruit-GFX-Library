...
public:
  ...
  */
  ...
  void drawRGBBitmap(int16_t x, int16_t y, uint16_t* bitmap, int16_t w, int16_t h, int16_t x_offset,
                     int16_t y_offset);
...
public:
  ...
  */
  ...
  uint8_t* getBufferRegion(int16_t x, int16_t y, int16_t w, int16_t h);
...
public:
  ...
  */
  ...
  uint16_t* getBufferRegion(int16_t x, int16_t y, int16_t w, int16_t h);
